...
const founder = {
  name: "Sajid Khan",
  role: "Founder & CEO",
  bio: "Former professional athlete turned tech entrepreneur. Built Court Connect to solve the venue discovery problem he faced as a player. With over 15 years in sports infrastructure development and a passion for technological innovation, Rahul leads the team in redefining how sports venues are discovered and utilized worldwide.",
  image: "/images/placeholders/profile.jpg",
};

export function AboutTeam() {
  return (
    <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 mt-10 ">
      <div className="max-w-360 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Portrait */}
          <div className="relative w-full aspect-square lg:aspect-square overflow-hidden bg-muted">
            <Image
              src={founder.image}
              alt={founder.name}
              fill
